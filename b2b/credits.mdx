...
```bash cURL
curl "https://api.agentgate.mynewapi.com/v1/credits/usage?startDate=2024-01-01" \
  -H "Authorization: Bearer YOUR_API_KEY"
```
...
```bash
curl "https://api.agentgate.mynewapi.com/v1/credits/usage?tenantId=acme-corp&startDate=2024-01-01" \
  -H "Authorization: Bearer YOUR_API_KEY"
```
